...
<div class="manual-reader">
    ...
    <div class="container manual-body">
        <div class="row">
            <div class="page-left">
                <ul class="menu">
                    <li class="active"><a href="{{urlfor "BookController.Dashboard" ":key" .Model.Identify}}" class="item"><i class="item-icon fa fa-dashboard" aria-hidden="true"></i> 概要</a> </li>
                    {{if eq .Model.RoleId 0 1}}
                        ...
                        <li><a href="{{urlfor "BookController.Setting" ":key" .Model.Identify}}" class="item"><i class="item-icon fa fa-gear" aria-hidden="true"></i> 设置</a> </li>
                    {{end}}
                </ul>
